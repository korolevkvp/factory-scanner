...
/**
 * REST controller for managing {@link com.vkorolev.myapp.domain.Factory}.
 */
@RestController
@RequestMapping("/api")
public class FactoryResource {
    ...
    public ResponseEntity<FactoryDTO> updateFactory(
        ...
        FactoryDTO result = factoryService.update(factoryDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<FactoryDTO> partialUpdateFactory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, factoryDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<FactoryDTO>> getAllFactories(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
